...
for (i=0; i < uncookedFood.length; i+=1) {
...
// Your task is to iterate over the array of uncookedFood
// and invoke the function for each item so that the cookedFood
// array contains all of the items after they are cooked.